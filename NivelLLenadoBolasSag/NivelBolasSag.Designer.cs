...
namespace NivelLLenadoBolasSag
{
    partial class NivelBolasSag
    {
        ...
        private void InitializeComponent()
        {
            ...
            string segundos = ConfigurationManager.AppSettings["Tiempo"];
            double tiempo = double.Parse(segundos);
